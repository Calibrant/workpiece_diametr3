...
class CustomDrawer extends StatelessWidget {
            ...
            Consumer<UnitProvider>(
              builder: (context, unitProvider, _) {
                return SwitchListTile(
                  secondary: const Icon(Icons.straighten, color: Color(0xFF08D9D6)),
                  title: Text(AppLocalizations.of(context)!.units_label),
                  subtitle: Text(
                    unitProvider.currentUnit == AppUnit.inch ? AppLocalizations.of(context)!.units_inch : AppLocalizations.of(context)!.units_mm,
  ...
  title: Text(AppLocalizations.of(context)!.menu_cnc_calculator),
  onTap: () {
    Navigator.pop(context); // Закрываем drawer
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const CNCCalculatorScreen()),
    );
  },
),
